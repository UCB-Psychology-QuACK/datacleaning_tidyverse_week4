...
mtcars_missingData$ratioMPGtoHP <- mtcars_missingData$mpg/mtcars_missingData$hp
mtcars_missingData$transmission <- ifelse(mtcars_missingData$am == 0, "automatic", "manual")
